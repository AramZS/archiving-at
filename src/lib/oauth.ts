...
export const WRITE_SCOPE = "atproto blob:application/zip blob:application/wacz blob:application/warc+gzip blob:application/warc repo:at.archiving.session repo:test.foo.bar?action=create&action=update rpc:app.bsky.actor.getProfile?aud=did%3Aweb%3Aapi.bsky.app%23bsky_appview";
